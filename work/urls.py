...
urlpatterns = [
    ...
    url(r"^value-equations-work/(?P<agent_id>\d+)/$", work.views.value_equations_work,
        name="value_equations_work"),
    url(r"^value-equation-sandbox-work/(?P<value_equation_id>\d+)/$", work.views.value_equation_sandbox_work,
        name="value_equation_sandbox_work"),
    url(r"^edit-value-equation-work/(?P<agent_id>\d+)/(?P<value_equation_id>\d+)/$", work.views.edit_value_equation_work,
        name="edit_value_equation_work"),
    url(r"^edit-value-equation-work/(?P<agent_id>\d+)/$", work.views.edit_value_equation_work,
        name="edit_value_equation_work"),
    ...
    url(r"^change-value-equation-bucket-work/(?P<bucket_id>\d+)/$", work.views.change_value_equation_bucket_work,
        name="change_value_equation_bucket_work"),
    url(r"^create-value-equation-bucket-rule-work/(?P<bucket_id>\d+)/$", work.views.create_value_equation_bucket_rule_work,
        name="create_value_equation_bucket_rule_work"),
    url(r"^delete-value-equation-bucket-work/(?P<bucket_id>\d+)/$", work.views.delete_value_equation_bucket_work, name="delete_value_equation_bucket_work"),
    url(r"^change-value-equation-bucket-rule-work/(?P<rule_id>\d+)/$", work.views.change_value_equation_bucket_rule_work,
